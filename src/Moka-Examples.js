define("moka/Moka-Examples", ["amber_vm/smalltalk", "amber_vm/nil", "amber_vm/_st", "amber_vm/globals", "moka/Moka-Core", "amber_core/Kernel-Objects"], function(smalltalk,nil,_st, globals){
smalltalk.addPackage('Moka-Examples');
smalltalk.packages["Moka-Examples"].transport = {"type":"amd","amdNamespace":"moka"};
