define("moka/Moka-Announcements", ["amber_vm/smalltalk", "amber_vm/nil", "amber_vm/_st", "amber_vm/globals", "amber_core/Kernel-Objects"], function(smalltalk,nil,_st, globals){
smalltalk.addPackage('Moka-Announcements');
smalltalk.packages["Moka-Announcements"].transport = {"type":"amd","amdNamespace":"moka"};
